    ...
    public void validation(){
        ...
        try{
            ...
            if(i_span_length<=10||i_span_length>=120){
                Toast.makeText(Input2.this, "Span length value should between 10 to 120", Toast.LENGTH_SHORT).show();
            }
            else if(i_bundle_strength<=10||i_bundle_strength>=120){
                Toast.makeText(Input2.this, "Bundle strength value should between 10 to 120", Toast.LENGTH_SHORT).show();
            }
            else if(i_micrnaire_value<=10||i_micrnaire_value>=120){
                Toast.makeText(Input2.this, "Micronaire value should between 10 to 120", Toast.LENGTH_SHORT).show();
            }
            else if(i_yarn_count<=10||i_yarn_count>=120){
                Toast.makeText(Input2.this, "Yarn count should between 10 to 120", Toast.LENGTH_SHORT).show();
            }
            else if(i_comber_noil<=10||i_comber_noil>=120){
                Toast.makeText(Input2.this, "Comber noil value should between 10 to 120", Toast.LENGTH_SHORT).show();
            }
            else {
            ...
            Toast.makeText(Input2.this, "please enter valid input", Toast.LENGTH_SHORT).show();
        }
    }
